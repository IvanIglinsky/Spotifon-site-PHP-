          ...
          <div class="album-songs" style="max-width: 100%;flex: 0 0 100%">
            <div class="album-info mb-50 d-flex flex-wrap align-items-center justify-content-between">
              <div class="album-all-songs">
                <div class="music-playlist UkraineHits">
<!--                    <script >-->
...
<!---->
<!---->
<!--                            for (let i = 0; i < names.UkraineHits[0].name.length; i++) {-->
<!--                                let playlistTopChart = document.querySelector("div.UkraineHits")-->
<!--                                let SingleMusic = document.createElement('div');-->
<!--                                SingleMusic.classList.add('single-music');-->
<!--                                let Name = document.createElement('h6');-->
<!--                                Name.innerHTML=names.UkraineHits[0].name[i];-->
<!--                                SingleMusic.appendChild(Name);-->
<!--                                let audioSing=document.createElement('audio');-->
<!--                                audioSing.preload='auto';-->
<!--                                let source=document.createElement('source');-->
<!--                                source.src=names.UkraineHits[0].way[i];-->
<!--                                let button=document.createElement('a')-->
<!--                                button.innerHTML='download'-->
<!--                                button.href=names.UkraineHits[0].way[i];-->
<!--                                button.download=''-->
...
<!--                    </script>-->
                  ...
                  <div class="single-music">
                      <a href="../audio/Ukraine%20Hits/myusli_ua_-_vova_ibash__ih_blyat__muzati.net.mp3" download="">  <h6>Мюслі - Вова **** іх</h6></a>
                    <audio preload="auto" controls>
                      <source src="../audio/Ukraine%20Hits/myusli_ua_-_vova_ibash__ih_blyat__muzati.net.mp3">
                    </audio>
                  </div>
                  <div class="single-music">
                      <a href="../audio/Ukraine%20Hits/INTERWORLD_-_METAMORPHOSIS_(musmore.com).mp3" download=""> <h6>Interworld - metamorphosis</h6></a>
                    <audio preload="auto" controls>
                      <source src="../audio/Ukraine%20Hits/INTERWORLD_-_METAMORPHOSIS_(musmore.com).mp3">
                    </audio>
                  </div>
                  <div class="single-music">
                  ...
                  <div class="single-music">
                      <a href="../audio/Ukraine%20Hits/krbk_-_24_muzati.net.mp3" download=""><h6>KRBK - 24</h6></a>
                      <audio preload="auto" controls>
                      <source src="../audio/Ukraine%20Hits/krbk_-_24_muzati.net.mp3">
                    </audio>
                  </div>
                  <div class="single-music">
                      <a href="../audio/Ukraine%20Hits/wellboy_-_vishni_muzati.net.mp3" download=""><h6>Wellboy - Вишні</h6></a>
                      <audio preload="auto" controls>
                      <source src="../audio/Ukraine%20Hits/wellboy_-_vishni_muzati.net.mp3">
                    </audio>
                  </div>
                  <div class="single-music">
                      <a href="../audio/Ukraine%20Hits/Yoxden_Vovking_Op_op_ZSU_pokazuye_Hip_hop.mp3" download=""><h6>YOXDEN - Оп оп ЗСУ показує хіп хоп</h6></a>
                    <audio preload="auto" controls>
                      <source src="../audio/Ukraine%20Hits/Yoxden_Vovking_Op_op_ZSU_pokazuye_Hip_hop.mp3">
                    </audio>
                  </div>
                  <div class="single-music">
      ...
      <div class="col-12">
        <div class="cta-content">
          <div class="cta-text">
            ...
            <h2>Ukraine music</h2>
            <h4>Search for the Ukraine Hits</h4>
          </div>
          <div class="cta-btn mt-30">
            <a href="UkraineHits.php" class="btn musica-btn">Search</a>
          </div>
        </div>
      </div>
    </div>
